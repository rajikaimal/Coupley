...
(function () {
    ...
    var t = !!document.createElement("canvas").getContext, ma = {
        ...
        for (t = r = k = m = p = 0; 0 < l.length;)if (b = l.pop(), "#" === b || "0" === b)if (p++, p === n) {
            ...
            d && (c = "-" + c)
        } else 0 < g.length ? (c = g.pop() + c, m++, t++
        ):
        "0" === b && (c = "0" + c, m++, t++), 0 === t % r && (k === q && 0 < g.length) && (c = f + c);
        else
        ...
        var b = 0, c = 0;
        a = a || window.event;
        a.offsetX || 0 === a.offsetX ? (b = a.offsetX, c = a.offsetY):a.layerX
        ||
        0 == a.layerX ? (b = a.layerX, c = a.layerY):(b = a.pageX - a.target.offsetLeft, c = a.pageY - a.target.offsetTop);
        return {x: b, y: c}
    ...
    w.prototype._plotAreaMouseUp = function (a, b) {
        ...
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (2 < Math.abs(e)) {
                ...
                this.axisX.sessionVariables.internalMinimum,this.axisX.sessionVariables.internalMinimum += d, this.axisX.sessionVariables.internalMaximum += d, e = !0
            ):
                this.axisX.sessionVariables.internalMaximum > this.axisX._absoluteMaximum && (d = this.axisX.sessionVariables.internalMaximum - this.axisX._absoluteMaximum, this.axisX.sessionVariables.internalMaximum -= d, this.axisX.sessionVariables.internalMinimum -= d, e = !0), e && this.render();
            else
                if (this.zoomEnabled) {
    ...
    w.prototype._plotAreaMouseMove = function (a, b) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if (2 < Math.abs(c) && (this.panEnabled || this.zoomEnabled))if (this.panEnabled) {
                ...
                c = 0;
                this.axisX.sessionVariables.internalMinimum < this.axisX._absoluteMinimum - $(this.axisX.interval, this.axisX.intervalType) ? (c = this.axisX._absoluteMinimum - $(this.axisX.interval, this.axisX.intervalType) - this.axisX.sessionVariables.internalMinimum,this.axisX.sessionVariables.internalMinimum += c, this.axisX.sessionVariables.internalMaximum += c
            ):
                this.axisX.sessionVariables.internalMaximum > this.axisX._absoluteMaximum + $(this.axisX.interval, this.axisX.intervalType) && (c = this.axisX.sessionVariables.internalMaximum -
        ...
        for (var b = this.plotArea, c = 0, d = 0, e = 0, f = 0, g = 0, k = d = g = e = 0, p = 0; p < this._indexLabels.length; p++) {
            ...
            if (null !== t && "" !== t) {
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    h = l.point.x - d / 2;
                    "inside" !== c ? (d = b.y1, e = b.y2,0 < s ? (n = l.point.y - k - g, n
                <
                    d && (n = "auto" === c ? Math.max(l.point.y, d) + g : d + g)
                ):
                    (n = l.point.y + g, n
                >
                    e - k - g && (n = "auto" === c ? Math.min(l.point.y, e) - k - g : e - k - g)
                )):
                    (d = Math.max(l.bounds.y1, b.y1), e = Math.min(l.bounds.y2, b.y2), c = 0 <= f.indexOf("range") ? 0 < s ? Math.max(l.bounds.y1,
                        b.y1) + k / 2 + g : Math.min(l.bounds.y2, b.y2) - k / 2 - g : (Math.max(l.bounds.y1, b.y1) + Math.min(l.bounds.y2, b.y2)) / 2,
                    0 < s ? (n = Math.max(l.point.y, c) - k / 2, n
                <
                    d && ("bubble" === f || "scatter" === f) && (n = Math.max(l.point.y - k - g, b.y1 + g))
                ):
                    (n = Math.min(l.point.y, c) - k / 2, n
                >
                    e - k - g && ("bubble" === f || "scatter" === f) && (n = Math.min(l.point.y + g, b.y2 - k - g))
                ))
                ...
                c ? (f = b.x1, g = b.x2,0 > s ? (h = l.point.x - d - e, h
            <
                f && (h = "auto" === c ? Math.max(l.point.x, f) + e : f + e)
            ):
                (h = l.point.x + e, h
            >
                g - d - e && (h = "auto" === c ? Math.min(l.point.x, g) - d - e : g - d - e)
            )):
                (Math.max(l.bounds.x1, b.x1), Math.min(l.bounds.x2, b.x2), c = 0 <= f.indexOf("range") ? 0 > s ? Math.max(l.bounds.x1, b.x1) + d / 2 + e : Math.min(l.bounds.x2, b.x2) - d / 2 - e : (Math.max(l.bounds.x1, b.x1) + Math.min(l.bounds.x2, b.x2)) / 2, h = 0 > s ? Math.max(l.point.x, c) - d / 2 : Math.min(l.point.x, c) - d / 2);
                "vertical" === r && (n += k);
                m.x = h;
                m.y = n;
                m.render(!0)
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < h.length) {
                    ...
                    for (c.setLineDash && c.setLineDash(M(l.lineDashType, l.lineThickness)); m < h.length; m++)if (s = h[m].x.getTime ? h[m].x.getTime() : h[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) {
                        ...
                        a.axisY.conversionParameters.pixelPerUnit * (h[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0, n
                    ||
                        C ? (c.beginPath(), c.moveTo(q, r), v = {
                            x: q,
                            y: r
        ...
        function (a) {
            ...
            function g(a, b) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    0 < k && (h = "right" === l.hemisphere ? m : q, c = k, null !== h && (q = k, k = s[h].indexLabelTextBlock.y - s[h].indexLabelTextBlock.height / 2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2), k - q < t && (d = q, r++, h = g(h, d), +h.toFixed(w) < +d.toFixed(w) && (c = k > t ? k - t : q - (d - h)))));
                    c && (k = l.indexLabelTextBlock.y + c, d = 0, d = "right" === l.hemisphere ? y.x + Math.sqrt(Math.pow(B, 2) - Math.pow(k - y.y, 2)) : y.x - Math.sqrt(Math.pow(B, 2) - Math.pow(k - y.y, 2)), l.midAngle > Math.PI / 2 - v && l.midAngle < Math.PI / 2 + v ? (h = (a - 1 + s.length) % s.length,
                                                                                                                                                                                                                                                                                  h = s[h], q = s[(a + 1 + s.length) % s.length],"left" === l.hemisphere && "right" === h.hemisphere && d > h.indexLabelTextBlock.x ? d = h.indexLabelTextBlock.x - 15 : "right" === l.hemisphere && ("left" === q.hemisphere && d < q.indexLabelTextBlock.x) && (d = q.indexLabelTextBlock.x + 15))
                :
                    l.midAngle > 3 * Math.PI / 2 - v && l.midAngle < 3 * Math.PI / 2 + v && (h = (a - 1 + s.length) % s.length, h = s[h], q = s[(a + 1 + s.length) % s.length], "right" === l.hemisphere && "left" === h.hemisphere && d < h.indexLabelTextBlock.x ? d = h.indexLabelTextBlock.x + 15 : "left" === l.hemisphere && ("right" === q.hemisphere &&
            ...
            function k() {
                ...
                for (var b = 0, c = a = 0, a = 0; 10 > a && (1 > a || 0 < c); a++) {
                        ...
                        for (var p, r, b = 0; b < n.length; b++) {
                            ...
                            if (null !== v) {
                                ...
                                if (0 > x) {
                                    ...
                                    p = -1 * (x - A);
                                    var E = r = 0;
                                    "right" === k.hemisphere ? (r = g(b, A), p = -1 * (x - r), E = g(v, p),+E.toFixed(w) < +p.toFixed(w) && +r.toFixed(w) <= +A.toFixed(w) && g(b, -(p - E))
                                ):
                                    (r = g(v, A), p = -1 *
                                    (x - r), E = g(b, p),
                                    +E.toFixed(w) < +p.toFixed(w) && +r.toFixed(w) <= +A.toFixed(w) && g(v, -(p - E))
                                )
                                }
                            }
                        }
                    ...
                    for (b = 0; b < n.length; b++)k = s[b], x = k.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width && (x = x = 0, "right" === k.hemisphere ? (x = q.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width + m), x*= -1)
                :
                    x = q.x1 - (k.indexLabelTextBlock.x - k.indexLabelTextBlock.width -
                    ...
                    x = q.y1 - (k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - 5), 0 < x && Math.abs(k.indexLabelTextBlock.x - y.x) < D && (x /= Math.abs(Math.sin(k.indexLabelAngle)),
                    9 < x && (x *= 0.3), x > c && (c = x))
                )
                    ;
                    b = function (a, b, c) {
    ...
    ca.prototype.render = function () {
        if (this.text) {
            ...
            this.verticalAlign && ("left" === this.horizontalAlign ? (c = b.x1 + 2, d = b.y2 - 2 - (this.maxWidth / 2 - l.width / 2), e = -90, p = "left",this.width = l.height, this.height = l.width)
        :
            "right" === this.horizontalAlign ? (c = b.x2 - 2, d = b.y1 + 2 + (this.maxWidth / 2 - l.width / 2), e = 90, p = "right",this.width = l.height, this.height = l.width
        ):
            "center" === this.horizontalAlign && (d = a.y1 + (a.height / 2 - l.height / 2), c = a.x1 + (a.width / 2 - l.width / 2), p = "center", this.width = l.width, this.height = l.height), k = "center"
        )
            ;
            f.x = c;
            f.y = d;
        ...
        if (0 < k.length) {
            ...
            for (l = 0; l < k.length; l++) {
                ...
                .
                    ...
                    (h = p[v], v = (v + 1) % p.length), this.height += n.textBlock.height;
    ...
    x.prototype.renderLabelsTicksAndTitle = function () {
        ...
        if ("bottom" === this._position) {
            for (var e = 0, f, e = 0; e < this._labels.length; e++)if (f =
                ...
                if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)this._labels[e].stripLine ? (c = this._labels[e].stripLine,this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle = c.color
            ):
                (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0, this.ctx.beginPath(),
            ...
            for (e = 0; e < this._labels.length; e++)if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                ...
                (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0, this.ctx.beginPath(), this.ctx.moveTo(c, b.y << 0), this.ctx.lineTo(c, b.y - this.tickLength << 0), this.ctx.stroke();
            ...
            for (e = 0; e < this._labels.length; e++)if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                ...
                (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0, this.ctx.beginPath(), this.ctx.moveTo(b.x << 0, c), this.ctx.lineTo(b.x - this.tickLength << 0, c), this.ctx.stroke();
            ...
            for (e = 0; e < this._labels.length; e++)if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                ...
                if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)this._labels[e].stripLine ? (c = this._labels[e].stripLine,this.ctx.lineWidth =
                    c.thickness, this.ctx.strokeStyle = c.color
            ):
                (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0, this.ctx.beginPath(), this.ctx.moveTo(b.x << 0, c), this.ctx.lineTo(b.x + this.tickLength << 0, c), this.ctx.stroke();
    ...
    x.prototype.renderInterlacedColors = function () {
        ...
        if (("left" === this._position ||
            "right" === this._position) && this.interlacedColor)for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++)this._labels[e].stripLine || (b ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position), b = e + 1 >= this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.maximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(d.x1, b.y, Math.abs(d.x1 - d.x2), Math.abs(b.y - c.y)), b = !1
        ):
        b = !0
        )
        ;
    ...
    x.prototype.calculateAxisParameters = function () {
        ...
        "axisY" === this.type && (c = "undefined" === typeof this._options.minimum || null === this._options.minimum ?
            this.dataInfo.viewPortMin : this._options.minimum, d = "undefined" === typeof this._options.maximum || null === this._options.maximum ? this.dataInfo.viewPortMax : this._options.maximum, isFinite(c) || isFinite(d) ? 0 === c && 0 === d ? (d += 9, c = 0) : 0 === d - c ? (f = Math.min(Math.abs(0.01 * Math.abs(d)), 5), d+= f, c -= f)
        :
        c > d ? (f = Math.min(Math.abs(0.01 * Math.abs(d - c)), 5),0 <= d ? c = d - f : d = c + f
        ):
        (f = Math.min(Math.abs(0.01 * Math.abs(d - c)), 0.05),
        0 !== d && (d += f), 0 !== c && (c -= f)
        ):
        (d = "undefined" === typeof this._options.interval ? -Infinity : this._options.interval,
        ...
        for (var c = 0, d = 0; d < a.length; d++) {
            ...
            if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                ...
                !1 === f.highlightEnabled || !0 !== c.highlightEnabled && !0 !== f.highlightEnabled || ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "scatter" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type ? (f = c.getMarkerProperties(g, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF",
                    f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), K.drawMarkers([f]), "undefined" !== typeof e.y2 && (f = c.getMarkerProperties(g, e.x1, e.y2, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), K.drawMarkers([f]))
            ):
                "bubble" === c.type ? (f = c.getMarkerProperties(g, e.x1, e.y1, this.chart.overlaidCanvasCtx), f
            .
                size = e.size, f.color = "white", f.borderColor = "white", b.globalAlpha = 0.3, K.drawMarkers([f]), b.globalAlpha =
                    1
            ):
                "column" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "bar" === c.type || "rangeBar" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "rangeColumn" === c.type ? I(b, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === c.type || "doughnut" === c.type ? ta(b, e.center, e.radius, "white", c.type, e.startAngle, e.endAngle, 0.3) : "candlestick" === c.type ? (b.globalAlpha = 1, b.strokeStyle = e.color, b.lineWidth = 2 * e.borderThickness, c = 0 === b.lineWidth % 2 ? 0 : 0.5, b.beginPath(), b.moveTo(e.x3 - c, e.y2),
    ...
    Q.prototype.getToolTipInnerHTML = function (a) {
        ...
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter))a = {
            ...
            for (var p = "", k = 0; k < a.length; k++)if (c = a[k].dataSeries, d = a[k].dataPoint, e = a[k].index, f = "", 0 === k && (g && !this.content) && (p += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] : "{x}", p += "</br>", p = this.chart.replaceKeywordsWithValue(p, d, c, e)), null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== c._options.toolTipContent)) {
                ...
                null === b && (b = "");
                !0 === this.reversed ? (b = this.chart.replaceKeywordsWithValue(f, d, c, e) + b, k
            <
                a.length - 1 && (b = "</br>" + b)
            ):
                (b += this.chart.replaceKeywordsWithValue(f, d, c, e), k < a.length - 1 && (b += "</br>"))
            }
            null !== b && (b = p + b)
        } else {
            c = a[0].dataSeries;
    ...
    var y = {
        ...
        drawMarker: function (a, b, c, d, e, f, g, k) {
            if (c) {
                ...
                "square" === d ? (c.beginPath(), c.rect(a - e / 2, b - e / 2, e, e), f && c.fill(), k && (g ? c.stroke() : (p = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = p)
            )):
                "triangle" === d ? (c.beginPath(), c.moveTo(a - e / 2, b + e / 2), c.lineTo(a + e / 2, b + e / 2), c.lineTo(a, b - e / 2), c.closePath(), f && c.fill(), k && (g ? c.stroke() : (p = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = p)
            ),
                c.beginPath()
            ):
...
document.createElement("canvas").getContext || function () {
    ...
    function T(a, b, c, g) {
        ...
        I ? k && n && b.push("<g_vml_:fill", ' position="', -c.x / k * f * f, ",", -c.y / n * d * d, '"', ' type="tile"', ' src="', e.src_, '" />') : (e = G(a.fillStyle), b
    .
        push('<g_vml_:fill color="', e.color, '" opacity="', e.alpha * a.globalAlpha, '" />')
    )
    }
