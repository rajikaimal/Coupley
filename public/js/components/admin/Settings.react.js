                ...
                <li>
                  <a href="#">
                    ...
                    <div className="progress progress-xxs">
                      <div className="progress-bar progress-bar-danger" styles={'width: 70%'}></div>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="#">
                    ...
                    <div className="progress progress-xxs">
                      <div className="progress-bar progress-bar-success" styles={'width: 95%'}></div>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="#">
                    ...
                    <div className="progress progress-xxs">
                      <div className="progress-bar progress-bar-warning" styles={'width: 50%'}></div>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="#">
                    ...
                    <div className="progress progress-xxs">
                      <div className="progress-bar progress-bar-primary" styles={'width: 68%'}></div>
                    </div>
                  </a>
                </li>
              </ul>
